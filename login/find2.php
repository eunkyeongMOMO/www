  ...
  */
  ...
  암호화된 pass가 입력된 pass의 암호화와 일치하는가를 확인해야함*/
        ...
        function generateRandomPassword($length=8, $strength=0) {
            ...
            if ($strength & 1) {
                $consonants .= 'BDGHJLMNPQRSTVWXZ1234567890!@#$';  //추가할 문자
            }
        ...
        echo "<p> <strong>코오롱글로벌 - 가입정보 </strong></p>
           <p>임시비밀번호는 <strong> $ranpass </strong> 입니다<p>
           <p> 아이디 :<span> $id </span> </P>
           <p>  이름 :<span> $name </span></P>
           <p>  연락처:<span> $hp </span></P>
           <p><strong>* 로그인 후 비밀번호를 변경해주세요.</strong><p>";
